...
{
    public partial class FormHrApproveOut : Form
    {
        ...
        private void FormHrApprove_Load(object sender, EventArgs e)
        {
            ...
            this.bntSave.Click += new EventHandler(bntSave_Click);
                    ...
                    try
                    {
                        ...
                        foreach (GridViewDataRowInfo row in GridViewShowData.Rows)
                        {
                            if (row.Index > -1)
                            {
                                ...
                                {
                                    sqlCommand.CommandText = string.Format(
                                    @"UPDATE [IVZ_HROUTOFFICE] SET [HrApprovedOut] = 2 
        ...
        private void GridViewShowData_CellClick(object sender, GridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                if (e.Column.Name == "OutOfficeId")
                {
                    ...
                    FormDetailHrApprove Frm = new FormDetailHrApprove(DocId, OutId);
                    Frm.Show();
                }
            }
        }
