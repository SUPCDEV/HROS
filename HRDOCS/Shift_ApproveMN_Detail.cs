...
namespace HRDOCS
{
    public partial class Shift_ApproveMN_Detail : Form
    {
        string DSDOCNO = "";

        public Shift_ApproveMN_Detail(string pDSDOCNO)
        {
            DSDOCNO = pDSDOCNO;
            InitializeComponent();
            InitializeForm();
        ...
        {
            this.Load += new EventHandler(Shift_ApproveMN_Detail_Load);
        }

        void Shift_ApproveMN_Detail_Load(object sender, EventArgs e)
        {
            Load_DataDS();
        }
