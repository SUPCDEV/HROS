...
namespace HRDOCS
{
    public partial class Chd_ApproveHD_Detail : Form
    {
        ...
        public Chd_ApproveHD_Detail(string DocId)
        {
            _docid = DocId;
            InitializeComponent();
        ...
        private void Chd_ApproveHD_Detail_Load(object sender, EventArgs e)
        {
            //InitializeDataGridView();
            //InitializaeGetData();
        }
