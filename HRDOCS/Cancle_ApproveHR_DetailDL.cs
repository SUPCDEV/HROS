...
namespace HRDOCS
{
    public partial class Cancle_ApproveHR_DetailDL : Form
    {
        ...
        public Cancle_ApproveHR_DetailDL(string DocId, string Doctype)
        {
            _docid = DocId;
            ...
            try
            {
                sqlCommand.CommandText = string.Format(
                         ...
                         @"SELECT HD.DOCID
                            ...
                            AND HD.HRAPPROVED = '0'
                            AND HD.DOCSTAT = '1'
                            AND DLHD.DOCSTAT = '1' ", _docid.ToString());
...
//                sqlCommand.CommandText = string.Format(
//                    @"UPDATE [SPC_CM_LEAVEHD] SET [DOCSTAT] = '0'
//                                ,[MODIFIEDBY] = @MODIFIEDBY
//								,[MODIFIEDDATE] = convert(varchar, getdate(), 23)
//                      WHERE [DLDOCNO] = @DLDOCNO
//                      AND DOCSTAT = 1 ");

//                sqlCommand.Parameters.AddWithValue("@DLDOCNO", _dldoc);
