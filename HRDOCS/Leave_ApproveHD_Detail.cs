...
namespace HRDOCS
{
    public partial class Leave_ApproveHD_Detail : Form
    {
        string DLDOCNO = "";
        public Leave_ApproveHD_Detail(string pDLDocNo)
        {
            DLDOCNO = pDLDocNo;
            InitializeComponent();
            InitializeForm();
        ...
        {
            this.Load += new EventHandler(Leave_ApproveHD_Detail_Load);
        }

        void Leave_ApproveHD_Detail_Load(object sender, EventArgs e)
        {
            Load_DataDL();
        }
