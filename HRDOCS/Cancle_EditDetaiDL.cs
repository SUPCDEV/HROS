...
namespace HRDOCS
{
    public partial class Cancle_EditDetaiDL : Form
    {
        ...
        public Cancle_EditDetaiDL(string DocId, string Doctype, string Docrefer)
        {
            _docid = DocId;
            _doctype = Doctype;
            _docrefer = Docrefer;
        ...
        private void Cancle_EditDetaiDL_Load(object sender, EventArgs e)
        {
