...
namespace HRDOCS
{
    public partial class Shift_SearchData : Form
    {
        public Shift_SearchData()
        {
            InitializeComponent();
            InitializeButton();
            InitializeComboBox();
        ...
        {
            this.Load += new EventHandler(Shift_SearchData_Load);
        }

        void Shift_SearchData_Load(object sender, EventArgs e)
        {
        ...
        private void InitializeDataGrid()
        {
            ...
            Dg_ShiftHD.Columns.Add(HEADAPPROVEDDATE);
            ...
            Dg_ShiftHD.Columns.Add(HRAPPROVEDDATE);
        ...
        {
            if (e.ColumnIndex == Dg_ShiftHD.Columns["Detail"].Index)
            {
                using (Shift_SearchDataDetail frm = new Shift_SearchDataDetail(Dg_ShiftHD.Rows[e.RowIndex].Cells["DSDOCNO"].Value.ToString()))
                {
                ...
                if (dataTable.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < dataTable.Rows.Count; i++)
                    {
                        Dg_ShiftHD.Invoke(new EventHandler(delegate
                        {
                            ...
                            Dg_ShiftHD.Rows[Dg_ShiftHD.RowCount - 1].Cells["HEADAPPROVEDDATE"].Value =
                            ...
                            Dg_ShiftHD.Rows[Dg_ShiftHD.RowCount - 1].Cells["HRAPPROVEDDATE"].Value =
